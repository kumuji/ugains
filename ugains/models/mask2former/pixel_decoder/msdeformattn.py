...
class MSDeformAttnPixelDecoder(nn.Module):
    def __init__(
        ...
        *,
        ...
        # DEPTH STUFF for extra fpn layers
        ...
        for idx, in_channels in enumerate(self.feature_channels[: self.num_fpn_levels]):
            ...
            # depth_norm = get_norm(norm, conv_dim)
    ...
    def forward(self, features):
        ...
        for idx, f in enumerate(self.in_features[: self.num_fpn_levels][::-1]):
            ...
            # depths.append(disp_to_depth(self.sigmoid(self.depth_convs[idx](y)))[1])
            y = output_conv(y)
            out.append(y)
        ...
        # return multi_scale_features, self.mask_features(out[-1]), depths
        return multi_scale_features, self.mask_features(out[-1])
...
def disp_to_depth(disp, min_depth=0, max_depth=80):
